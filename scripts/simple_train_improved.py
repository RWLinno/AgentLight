#!/usr/bin/env python
"""
Simplified training script for traffic control
"""
import os
import sys
import torch
...
def main():
    ...
    # Create environment with proper configuration structure
    env_config = {
        "path_to_log": "./log",
        "path_to_work_directory": "/home/weilinruan/data/traffic",
        ...
        "dic_path": {
            "PATH_TO_DATA": "/home/weilinruan/data/traffic"
        },
        "max_steps": 300,
        "num_intersections": 1,
    ...
    print("Creating traffic control environment with config:")
