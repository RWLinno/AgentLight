...
def main(in_args):
    ...
    # Print debugging information about the configuration
    print("\n===== TRAFFIC SIMULATION CONFIGURATION =====")
    print(f"Dataset: {in_args.dataset}")
    print(f"Road Net: {road_net} ({NUM_ROW}x{NUM_COL})")
    print(f"Number of Intersections: {num_intersections}")
    print(f"Traffic File: {in_args.traffic_file}")
    print(f"Model: {in_args.model}")
    print(f"GPT Version: {in_args.gpt_version}")
    print(f"Eight Phase: {in_args.eightphase}")
    print("===========================================\n")
